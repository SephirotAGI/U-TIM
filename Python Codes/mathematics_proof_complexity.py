...
if __name__ == "__main__":
    ...
    # Define a mathematics-specific U-TIM implementation
    class MathTIM(UniversalTIM):
        def dC_dt(self, x, theta):
            return np.abs(theta - x**0.5)  # Complexity scaling function

    # Run U-TIM computation
    utim = MathTIM(model, reference, PosteriorSampler(0.5, 0.1), lambda x, θ: 1.0, config=config)
